import type { Bug, PlaywrightStep, SpecFile } from '#/types/domain';

import { escapeJsString, shortTitle, slugify } from './format';
 ...
 */
export function buildTestFromSteps({
  name,
  baseUrl,
  steps = [],
}: {
 ...
 */
export function buildPrompt(bug: Partial<Bug> = {}): string {
  return [
